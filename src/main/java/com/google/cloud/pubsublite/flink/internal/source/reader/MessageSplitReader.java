...
public class MessageSplitReader
  ...
  final PullSubscriberFactory factory;
  final Map<String, BlockingPullSubscriber> subscribers;

  public MessageSplitReader(PullSubscriberFactory factory) {
  ...
  private void closeAll(Collection<BlockingPullSubscriber> subscribers) throws Exception {
    Exception exception = null;
    for (BlockingPullSubscriber sub : subscribers) {
      try {
        sub.close();
      } catch (Exception t) {
        exception = t;
